...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260321212618.png)

Панели на `/manager` и `/host-manager` были закрыты

![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260321213023.png)

Поиск через  `searсhsploit` показал несколько уязвимостей для данной версии приложения

![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260321221612.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260321222558.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260321220741.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260321231028.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260321231619.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260321235957.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322000100.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322000924.png)

Открываем GitLab и обнаруживаем включенную регистрацию

![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322003424.png)

После создания аккаунта мы видим несколько репозиториев

![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322003600.png)

В `Administrator / Virtualhost` в `README.md` можно заметить еще один vhost `monitoring.inlanefreight.local`

![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322003641.png)

Добавляем запись в  `/etc/hosts` и открываем адрес в браузере

![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322003850.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322010625.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322011001.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322021157.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322021236.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322023550.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322121658.png)
...
![alt text](https://github.com/zhabii/htb-writeups/blob/main/media/attacking%20common%20applications/Pasted%20image%2020260322121937.png)
